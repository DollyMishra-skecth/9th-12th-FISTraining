...
public class GlobalExceptionHandeler extends ResponseEntityExceptionHandler {
	public GlobalExceptionHandeler() {
		// TODO Auto-generated constructor stub
	}
	@ExceptionHandler(ResourceNotFound.class)
	public ResponseEntity<?> resourceNotFoundExceptionHandler(ResourceNotFound ex, WebRequest request){
		ErrorDetails errorDetails = new com.fisglobal.organizationservice.utils.ErrorDetails(new Date(), ex.getMessage(), request.getDescription(false));
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ErrorDetails details = new ErrorDetails(new Date(), ex.getMessage(),"Not Valid");
